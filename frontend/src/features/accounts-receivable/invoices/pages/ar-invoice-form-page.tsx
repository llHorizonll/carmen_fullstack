...
export function ArInvoiceFormPage() {
  ...
  // Queries
  const { data: invoice, isLoading: isLoadingInvoice } = useArInvoice(id)
  ...
  const calculateTax = useCalculateArTax()
  ...
  const canEdit = !isEdit || invoice?.status === ArInvoiceStatus.Draft
    ...
    return (
      <div className="space-y-6">
        <div className="flex items-center gap-4">
          ...
          <h1 className="text-2xl font-bold">{t("ar.invoices.form.cannotEdit")}</h1>
        </div>
        <Card>
          <CardContent className="pt-6">
            <p className="text-muted-foreground">
              {t("ar.invoices.form.cannotEditDesc")}
            </p>
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="flex-1">
          <h1 className="text-2xl font-bold tracking-tight">
            {isEdit ? t("ar.invoices.form.editTitle") : t("ar.invoices.form.newTitle")}
          </h1>
          {isEdit && invoice && (
            <p className="text-muted-foreground">
              {t("ar.invoices.form.invoice")}: <span className="font-mono">{invoice.invoiceNumber}</span>
            </p>
          )}
        </div>
      </div>
      ...
      <Form {...form}>
        <form className="space-y-6">
          ...
          <Card>
            <CardHeader>
              <CardTitle>{t("ar.invoices.form.invoiceDetails")}</CardTitle>
            </CardHeader>
            <CardContent>
              <div className="grid gap-4 md:grid-cols-3">
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>{t("ar.invoices.form.customer")}</FormLabel>
                      <Select
                        value={field.value}
                      ...
                      >
                        <FormControl>
                          <SelectTrigger>
                            <SelectValue placeholder={t("ar.invoices.form.selectCustomer")} />
                          </SelectTrigger>
                        </FormControl>
                        <SelectContent>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>{t("ar.invoices.form.customerReference")}</FormLabel>
                      <FormControl>
                        <Input placeholder={t("ar.invoices.form.customerInvoicePlaceholder")} {...field} />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>{t("ar.invoices.form.reference")}</FormLabel>
                      <FormControl>
                        <Input placeholder={t("ar.invoices.form.referencePlaceholder")} {...field} />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>{t("ar.invoices.form.invoiceDate")}</FormLabel>
                      <FormControl>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>{t("ar.invoices.form.dueDate")}</FormLabel>
                      <FormControl>
                        <Input type="date" {...field} />
                      </FormControl>
                      <FormMessage />
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>{t("ar.invoices.form.currency")}</FormLabel>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>{t("ar.invoices.form.exchangeRate")}</FormLabel>
                      <FormControl>
                        <Input
                          type="number"
                          step="0.0001"
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input placeholder={t("ar.invoices.form.descriptionPlaceholder")} {...field} />
                        </FormControl>
                        <FormMessage />
                      </FormItem>
                    )}
          ...
          <Card>
            <CardHeader className="flex-row items-center justify-between space-y-0">
              <CardTitle>{t("ar.invoices.form.lineItems")}</CardTitle>
              <Button type="button" variant="outline" size="sm" onClick={handleAddLine}>
                <Plus className="mr-2 size-4" />
                {t("ar.invoices.form.addLine")}
              </Button>
            </CardHeader>
            <CardContent>
                ...
                <Table>
                  <TableHeader>
                    <TableRow>
                      ...
                      <TableHead className="min-w-50">{t("ar.invoices.form.account")}</TableHead>
                      <TableHead className="w-25">{t("ar.invoices.form.quantity")}</TableHead>
                      <TableHead className="w-32">{t("ar.invoices.form.unitPrice")}</TableHead>
                      <TableHead className="w-32">{t("ar.invoices.form.amount")}</TableHead>
                                  ...
                                  >
                                    <FormControl>
                                      <SelectTrigger className="w-full">
                                        <SelectValue placeholder={t("ar.invoices.form.selectAccount")} />
                                      </SelectTrigger>
                                    </FormControl>
                                    <SelectContent>
                          ...
                          <TableCell>
                            <FormField
                              ...
                              render={({ field }) => (
                                <FormItem className="space-y-0">
                                  <FormControl>
                                    <Input placeholder={t("ar.invoices.form.lineDescriptionPlaceholder")} {...field} />
                                  </FormControl>
                                </FormItem>
                              )}
                            />
          ...
          <Card>
            <CardHeader className="flex-row items-center justify-between space-y-0">
              <CardTitle>{t("ar.invoices.form.taxesAndTotals")}</CardTitle>
              <Button
                type="button"
                variant="outline"
                size="sm"
                onClick={handleCalculateTax}
                disabled={calculateTax.isPending || !watchedCustomerId}
              >
                <Calculator className="mr-2 size-4" />
                {t("ar.invoices.form.calculateTax")}
              </Button>
            </CardHeader>
            <CardContent>
              <div className="grid gap-6 md:grid-cols-2">
                ...
                <div className="space-y-4">
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel>{t("ar.invoices.form.discount")}</FormLabel>
                        <FormControl>
                          <Input
                            type="number"
                            step="0.01"
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel>{t("ar.invoices.form.vat")}</FormLabel>
                        <Select value={field.value} onValueChange={field.onChange}>
                          <FormControl>
                            <SelectTrigger>
                              <SelectValue placeholder={t("ar.invoices.form.selectTaxProfile")} />
                            </SelectTrigger>
                          </FormControl>
                          <SelectContent>
                            <SelectItem value="none">{t("ar.invoices.form.noTax")}</SelectItem>
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel>{t("ar.invoices.form.serviceTax")}</FormLabel>
                        <Select value={field.value} onValueChange={field.onChange}>
                          <FormControl>
                            <SelectTrigger>
                              <SelectValue placeholder={t("ar.invoices.form.selectTaxProfile")} />
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel>{t("ar.invoices.form.wht")}</FormLabel>
                        <Select value={field.value} onValueChange={field.onChange}>
                          <FormControl>
                            <SelectTrigger>
                              <SelectValue placeholder={t("ar.invoices.form.selectTaxProfile")} />
          ...
          <div className="flex items-center justify-end gap-4">
            ...
            >
              ...
              {t("ar.invoices.form.saveAsDraft")}
            </Button>
            <Button
              type="button"
            ...
            >
              ...
              {t("ar.invoices.form.saveAndSubmit")}
            </Button>
          </div>
        </form>
      </Form>
